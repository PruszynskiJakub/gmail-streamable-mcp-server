...
export const toolsMetadata = {
  ...
  search_threads: {
    ...
    description:
      'Search threads by Gmail query and/or labelIds. Returns subject, sender, date, message count, unread status, and web links. Use get_thread to read full message bodies.',
  },
